...
$sql = "SELECT c.*, cat.name AS category_name, u.name AS creator_name, (SELECT COUNT(*) FROM enrollments e WHERE e.course_id=c.id) AS ticket_count
...
<div class="table-wrap" style="margin-top:20px;">
  <table>
    <thead><tr><th>Event</th><th>Organizer</th><th>When</th><th>Price</th><th>Tickets Sold</th><th>Status</th><th></th></tr></thead>
    <tbody>
      ...
      <?php endforeach; ?>
      <?php if (!$events): ?><tr><td colspan="7" class="muted">No events match this filter.</td></tr><?php endif; ?>
    </tbody>
  </table>
</div>
