...
$events = db_all('
    SELECT c.*, cat.name AS category_name, (SELECT COUNT(*) FROM enrollments e WHERE e.course_id = c.id) AS ticket_count
...
<?php else: ?>
  <div class="table-wrap reveal" style="margin-top:24px;">
    <table>
      <thead><tr><th>Event</th><th>When</th><th>Price</th><th>Tickets</th><th>Status</th><th></th></tr></thead>
      <tbody>
