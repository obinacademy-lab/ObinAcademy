...
//
// Gated behind cookie consent (cookie-consent.js, loaded first): runs
// immediately if already accepted, waits for an explicit accept if the
// visitor hasn't decided yet, and never runs at all if rejected.
(() => {
  function start() {
