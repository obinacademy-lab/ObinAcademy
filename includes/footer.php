    ...
    <div class="container">
      <div class="footer-cols">
        <div class="footer-col-brand">
          <?php render_logo(); ?>
          <p>Practical skills, real income — taught by African creators, paid for with mobile money.</p>
        </div>

        <div class="footer-col">
          <div class="footer-col-head"><span class="dash" aria-hidden="true"></span><span>Explore</span></div>
          <ul>
            <?php foreach ($footerNavLinks as $href => $label): ?>
              <li><a href="<?= e(base_url($href)) ?>"><?= e($label) ?></a></li>
            <?php endforeach; ?>
          </ul>
        </div>

        <div class="footer-col">
          <div class="footer-col-head"><span class="dash" aria-hidden="true"></span><span>Connect</span></div>
      ...
      <div class="footer-bottom-row">&copy; <?= date('Y') ?> Obin Academy. All rights reserved.</div>
    </div>
  </footer>
