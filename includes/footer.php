  ...
  <footer class="site-footer site-footer-compact">
    <div class="container">
      <div class="footer-bar">
        <?php render_logo(); ?>
        <span class="footer-bar-div" aria-hidden="true"></span>
        <nav class="footer-bar-nav">
          <?php foreach ($footerNavLinks as $href => $label): ?>
            <a href="<?= e(base_url($href)) ?>"><?= e($label) ?></a>
          <?php endforeach; ?>
        </nav>
        <span class="footer-bar-spacer"></span>
        <span class="footer-bar-copy">&copy; <?= date('Y') ?> Obin Academy</span>
        <span class="footer-bar-div" aria-hidden="true"></span>
        <a href="https://wa.me/256775361998?text=<?= urlencode('Hi, I have a question about Obin Academy') ?>" target="_blank" rel="noopener noreferrer" class="whatsapp-chip">
